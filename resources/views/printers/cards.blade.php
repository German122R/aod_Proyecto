...
<h2 class="text-primary"> {{  $printer->brand }} {{  $printer->model }} </h2>
</div>
<div class="card-body">
<p class="card-text text-truncate">{{  $printer->description }}</p>

<div class="">
<p class="text-muted">Color: {{$printer->color}}</p>
</div>
<div class="">
<p class="text-muted">speeds: {{$printer->speed}}</p>
</div>
</div>

...
<head>
  ...
  <link href="{{asset('homes/asset/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  ...
  <link href="{{asset('homes/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        <div class="logo">
          <h1 class="text-light"><a href="index.html"><span>German.R XD</span></a></h1>
        ...
        <nav id="navbar" class="navbar">
          <ul>
          <li><a class="nav-link scrollto" href="{{url('login')}}">INGRESAR A REGISTRO</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>"PROYECTO: GERMAN RICARDO"</h1>
      <h2>Ing.Infomatica</h2>
      <a href="#about" class="btn-get-started scrollto">comunicarse con German</a>
    </div>
  </section><!-- End Hero -->
